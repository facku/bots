// ==UserScript==
// @name         Sews Bot CUILS[cliente]
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Pluggin para automatizar consultas en SEWS y obtener Fecha Nacimiento
        ...
        if(settings.url=="controlador/cliente/generarPDF.php"){
            ...
            if(window.stado.pdf==2 && window.stado.pdf==2){
                ...
                setTimeout(function(){
                    ...
                    $('button.btn.btn-default:contains("Cerrar")').click();
                    //aca vami logica
                    var cuil = $('tbody.resultadosTematica td')[1].innerText
                    var fnac = $('tbody.resultadosTematica td')[6].innerText
                    window.TABLA.push({cuil,fnac})
                    ...
                    if(window.socios.length>0){
                        ...
                        var blob = new Blob([JSON.stringify(window.TABLA)], {type: 'text/json'}),
